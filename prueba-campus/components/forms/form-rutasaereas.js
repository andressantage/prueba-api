export class formRutasaereas extends HTMLElement{
    constructor(){
        super();
        this.render();
    }
    render(){
        this.innerHTML = /*html*/`
        <div class="card">
        <h5 class="card-header">Registro de rutas aereas</h5>
        <div class="card-body">
            <div class="container">
                <div class="row g-3">
                    <div class="col-12">
...
customElements.define("form-rutasaereas",formRutasaereas);